          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="mt-8 space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  Há mais de 8 anos, dedico-me ao estudo e à compreensão do ser
                  humano de forma integral, considerando os diversos aspectos
                  que influaneciam sua maneira de sentir, pensar, agir e se
                  relacionar com o mundo. Também ofereço orientação parental,
                  auxiliando pais e responsáveis na compreensão das necessidades
                  emocionais e comportamentais de seus filhos, favorecendo
                  relações familiares mais saudáveis e promovendo o
                  desenvolvimento infantil.
                </p>
                <p>
                  Atualmente, também atuo em uma clínica multidisciplinar,
                  realizando atendimentos a crianças e adolescentes neurotípicos
                  e neurodrivergentes, contribuindo para o desenvolvimento de
                  habilidades socioemocionais, comunicativas, comportamentais e
                  de autonomia.
                </p>
              </div>
            </div>
              ...
              <div className="aspect-4/5 overflow-hidden rounded-2xl border border-border/60 bg-card shadow-sm lg:aspect-5/5">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center p-8">
                    <div className="w-36 h-36 mx-auto rounded-full flex items-center justify-center mb-6 lg:w-48 lg:h-48">
                      <Image
                        src="/ana-about-pic.png"
                        alt="User image"
                        width={150}
                        height={150}
                        className="mb-10 rounded-full translate-y-4 lg:w-48 lg:absolute"
                      />
                    </div>
